...
@interface TDDetailViewController () <UINavigationControllerDelegate, UIImagePickerControllerDelegate,
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (itemKey) {
        ...
        UIImage *imageToDisplay = [[TDImageStore sharedStore] imageForKey:itemKey];
...
- (void)cancel:(id)sender
{
    ...
    [[TDItemStore sharedStore] removeItem:self.item];
...
- (IBAction)showAssetTypePicker:(id)sender
{
    ...
    TDAssetTypeViewController *avc = [[TDAssetTypeViewController alloc] init];
    avc.item = self.item;
...
didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    ...
    if (oldKey) {
        ...
        [[TDImageStore sharedStore] deleteImageForKey:oldKey];
    }
    ...
    [[TDImageStore sharedStore] setImage:image forKey:self.item.itemKey];
